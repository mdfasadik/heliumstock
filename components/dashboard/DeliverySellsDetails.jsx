...
export default function DeliverySellsDetails({
  sell,
  setSelectedSell,
  api,
  authToken,
  ...
  return (
    <div className='w-screen h-screen backdrop-blur-sm fixed bg-black/40 z-40 px-2'>
      <div className='bg-white p-6 lg:w-2/3 w-screen mx-auto mt-10 rounded-lg'>
        ...
        <div className='container mt-10 mx-auto'>
          ...
          <div className='text-right w-full'>
            ...
            <div className='flex gap-4 justify-end items-center'>
              ...
              <h1 className='text-2xl font-medium'>
                {" "}
                {(Math.round(sell.totalProfit * 100) / 100).toFixed(2)}
              </h1>
            </div>
          </div>
